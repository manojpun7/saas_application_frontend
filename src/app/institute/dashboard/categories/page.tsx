...
import CategoryTableSkeleton from "@/lib/components/skeleton/CategoryTableSkeleton";
    ...
    <div className="flex flex-col">
      <div className=" overflow-x-auto">
        ...
        <div className="min-w-full inline-block align-middle">
          <div className="flex justify-between relative  text-black-500 focus-within:text-gray-900 mb-4">
            ...
            <button
              onClick={openModal}
              className="bg-green-400 h-[34px] p-2 rounded cursor-pointer"
            >
              + Category
            </button>
          </div>
